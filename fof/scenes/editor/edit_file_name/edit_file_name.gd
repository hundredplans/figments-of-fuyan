...
@onready var lock_open_sfx: AudioStreamWAV = preload("res://assets/sounds/UI/lock_button/lock_open_sfx.wav")
@onready var lock_closed_sfx: AudioStreamWAV = preload("res://assets/sounds/UI/lock_button/lock_closed_sfx.wav")
