...
@onready var UpgradedBoonText: TextEdit = $Contents/UpgradedBoonText
...
func on_boon_selected(item_info: Dictionary) -> void:
	...
	UpgradedBoonText.text = item_info.utext
