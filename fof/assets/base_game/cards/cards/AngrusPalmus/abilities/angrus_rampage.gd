...
func onRampageCondition() -> bool: return !GameEffects.onGameFXExists(Unit, GameFXGD.ABILITY_ACTIVE)
func onRampage() -> void:
	...
	GameEffects.addGFX(Unit, GameFXGD.ABILITY_ACTIVE, {"ability": self}, [Trigger])
