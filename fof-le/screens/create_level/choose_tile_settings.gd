...
func on_change_setting():
	...
	match tile_colors:
		false: 
			circle_size = 120
			var arrow_states: Control = preload("res://screens/create_level/arrow_states.tscn").instantiate()
		...
		true: 
			circle_size = 200
			var set_tile_colors: Control = preload("res://screens/create_level/tile_colors.tscn").instantiate()
