...
func setInfo(_card_info: CardInfo, _tier: int) -> void:
	...
	var tier_datastore: CardTierDatastore = card_info.getUpdatedTierDatastore(tier)
	...
	CardTextEdit.text = tier_datastore.getDescription(true)
	
func getSavedTierDatastore() -> CardTierDatastore:
