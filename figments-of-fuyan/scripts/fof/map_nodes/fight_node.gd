...
func onSave() -> SavedDataMapNode:
	return SavedDataMapNodeFight.new(info.id, false, public_id, map_location, links, is_entered, is_finished, rotation.y, level_info, enemy_spawns)
...
func onLoadEntered() -> bool:
	...
	is_finished = true # Set prematurely as this doesn't decide whether it's finished but level data in area
	return true
#endregion
