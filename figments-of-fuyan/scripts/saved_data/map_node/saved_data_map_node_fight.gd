...
func _init(_id: int = 0, _first_init: bool = false, _map_location: MapLocation = null, _links: Array = [], _is_entered: bool = false, _is_finished: bool = false,\
	_rotation_y: float = 0, _level_info: LevelInfo = null, _spawn_ids: Array = []) -> void:
