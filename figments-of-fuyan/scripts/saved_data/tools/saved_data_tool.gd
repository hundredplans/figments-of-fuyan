...
func _init(_id: int = 0, _first_init: bool = false, _public_id: int = 0, _ascended: bool = false, _active_effects: Array[ActiveEffectDatastore] = [],\
 	_charges: int = 0, _ability_save: Dictionary = {}) -> void:
