...
@export var card_place: CardGD.CARD_PLACES
...
func _init(_id: int = 0, _first_init: bool = false, _coords := Vector4i.ZERO,\
 _tile_rotation: int = 0, _level_visible: bool = true, _team: int = 0, _attack: int = 0, _health: int = 0,\
	_speed: int = 0, _max_health: int = 0, _energy: int = 0, _ascended: bool = false,\
	_draw_order: int = 0, _card_place: CardGD.CARD_PLACES = CardGD.CARD_PLACES.NULL) -> void:
