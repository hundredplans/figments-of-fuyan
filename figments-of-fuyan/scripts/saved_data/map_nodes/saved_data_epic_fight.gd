...
func _init(_id: int = 0, _first_init: bool = false, _public_id: int = 0, _map_location: MapLocation = null, _links: Array = [], _is_entered: bool = false, _is_finished: bool = false,\
	_rotation_y: float = 0, _ability_save: Dictionary = {}, _level_info: LevelInfo = null, _spawn_group: String = "", _enemy_cards: Array = [], _level_preview: LevelPreview = null, _boss_id: int = 0) -> void:
