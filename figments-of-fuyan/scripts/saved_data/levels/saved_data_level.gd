...
@export var hand_cards_public_ids: Array
...
func _init(_id: int = 0, _first_init: bool = false, _public_id: int = 0, _data: Array = [], _enemy_cards: Array = [], _field_cards_data: Array = [], \
	...
	_level_preview: LevelPreview = null, _env: Environment = null, _hand_cards_public_ids: Array = []) -> void:
	...
	env = _env
	hand_cards_public_ids = _hand_cards_public_ids
