...
func _init(_id: int = 0, _first_init: bool = false, _public_id: int = 0, _data: Array = [], _timeout: int = 0, _enemy_spawn_ids: Array = [], _field_cards_data: Array = [], \
	...
	super(_id, _first_init, _public_id, _data, _timeout, _enemy_spawn_ids, _field_cards_data, _phase, _level_camera_data, _energy, _max_energy)
