...
@export var hurt_modifier: String
...
func setHurtModifier(_hurt_modifier: String) -> void:
	hurt_modifier = _hurt_modifier
...
func getHurtModifier() -> String:
	return hurt_modifier
